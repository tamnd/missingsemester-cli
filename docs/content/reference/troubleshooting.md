...
Most of these come down to network reality or how missingsemester serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

missingsemester rate-limits like any public site. missing already paces
...
Where a surface is gated, missing reads a cookie or token you supply
...
`missing`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what missing actually did
