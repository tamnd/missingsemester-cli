...
```
missing <command> [arguments] [flags]
```

Run `missing <command> --help` for the full flag list on any command. This
...
per operation you declare in `missingsemester/domain.go`.
