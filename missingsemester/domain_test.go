...
// HTTP behaviour is covered in missingsemester_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "missingsemester://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("missingsemester", "about")
	if err != nil || got.String() != "missingsemester://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want missingsemester://page/about", got.String(), err)
	}
}
